                ...
                <div class="inforight">
                    ...
                    <div class="bottom">
                        <ul>
                            ...
                            <li><changegmsl :initCount="item.cou"
                                            :goodsid="item.id"
                                            v-on:data="getiInputNumber"></changegmsl></li>
...
<script>
    ...
    import {getgoodsObject,updateData,remoteItem} from "../local.js"

    import changegmsl from "./changegmsl.vue"
...
//				2.0 将id值按照 api的参数格式提交给api
                ...
                var url  = allApi.allApi + '/api/goods/getshopcarlist/'+idstring;
